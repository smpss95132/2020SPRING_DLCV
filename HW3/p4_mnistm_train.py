...
class Parameter:
    ...
    folder = '../weights/[4]USPS_MNISTM_re'  
    
    # data root
    TRAIN_ROOT_PATH_s = '../hw3_data/digits/usps/train'
    TRAIN_ROOT_PATH_t = '../hw3_data/digits/mnistm/train'
    
    TEST_ROOT_PATH_s = '../hw3_data/digits/usps/test'
    TEST_ROOT_PATH_t = '../hw3_data/digits/mnistm/test'
    
    ENCODER_PATH = '../weights/[3-1]USPS/best-checkpoint_acc.bin'
...
def run_training(net, args):
    ...
    strain_dataset = DatasetRetriever_USPS(args.TRAIN_ROOT_PATH_s, strain_meta, get_USPS_transforms())
    ttrain_dataset = DatasetRetriever_MNISTM(args.TRAIN_ROOT_PATH_t, ttrain_meta, get_MNISTM_transforms())
    tvalid_dataset = DatasetRetriever_MNISTM(args.TRAIN_ROOT_PATH_t, tvalid_meta, get_MNISTM_transforms())
...
class USPS2MNISTM(nn.Module):
    def __init__(self, backbone):
        super(USPS2MNISTM, self).__init__()
...
def main():
    ...
    model = USPS2MNISTM(models.resnet18(pretrained=False))
